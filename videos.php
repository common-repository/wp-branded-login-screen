<?php
/*
Plugin Name: Wp Video Plugin
Plugin URI: http://111waystomakemoney.com/wp-video-plugin/
Description: For using the plugin, read the <a href="http://111waystomakemoney.com/wp-video-plugin/" title="Wp Video Plugin">Wp Video Plugin Instruction Page</a> .A filter for WordPress that displays videos from many video services. Enter [videosite id] at a post and you will see a video.For Instructions read the readme file 
Version: 6.01.14
Author: Sagar 
...
// Metacafe Code define("METACAFE_WIDTH", 400);
